            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-col items-center space-y-3 pt-4 border-t border-border/50">
                  <AIPrompts 
                    chineseCharacters={result.chineseCharacters}
                    title="Sample prompts you can use:"
                    description="You can copy your chart and ask ChatGPT, DeepSeek, or other AI tools for more insights about your BaZi reading!"
                  />
                </div>
              </div>
            </CardContent>
